...
export const seedTournaments: TournamentPoster[] = [
  {
    ...
    game: 'Valorant',
    imageUrl: 'https://placehold.co/400x600/FF4655/white?text=VALORANT+CHAMPIONS&font=raleway',
  ...
  },
  {
    ...
    game: 'CS:GO',
    imageUrl: 'https://placehold.co/400x600/FF6B00/000000?text=CS:GO+PRO+LEAGUE&font=raleway',
    format: 'round_robin',
    prizeReward: '$10,000',
    entryFee: 1000,
  ...
  },
  {
    ...
    imageUrl: 'https://placehold.co/400x600/0AC8B9/000000?text=LEAGUE+OF+LEGENDS&font=raleway',
    format: 'swiss',
    prizeReward: '$15,000',
  ...
  },
  {
    ...
    game: 'Apex Legends',
    imageUrl: 'https://placehold.co/400x600/DA292E/white?text=APEX+LEGENDS&font=raleway',
    format: 'single_elimination',
    prizeReward: '$3,000',
    entryFee: 250,
    organizerId: 'user-carol-101',
  ...
  },
  {
    ...
    game: 'Fortnite',
    imageUrl: 'https://placehold.co/400x600/7B3FF2/white?text=FORTNITE+CHAMPIONSHIP&font=raleway',
    format: 'single_elimination',
    prizeReward: '$8,000',
    entryFee: 750,
    organizerId: 'user-alice-456',
  ...
  },
  {
    ...
    game: 'Rocket League',
    imageUrl: 'https://placehold.co/400x600/0095FF/white?text=ROCKET+LEAGUE&font=raleway',
    format: 'round_robin',
    prizeReward: '$6,500',
    entryFee: 600,
    organizerId: 'user-bob-789',
  ...
  },
  {
    ...
    game: 'Overwatch',
    imageUrl: 'https://placehold.co/400x600/FF8C00/000000?text=OVERWATCH&font=raleway',
    format: 'single_elimination',
    prizeReward: '$7,200',
    entryFee: 650,
    organizerId: 'user-carol-101',
  ...
  },
  {
    ...
    game: 'PUBG Mobile',
    imageUrl: 'https://placehold.co/400x600/F2C94C/000000?text=PUBG+MOBILE&font=raleway',
    format: 'swiss',
    prizeReward: '$4,500',
    entryFee: 400,
    organizerId: 'user-alice-456',
  ...
  },
  {
    ...
    imageUrl: 'https://placehold.co/400x600/27AE60/white?text=RAINBOW+SIX&font=raleway',
    format: 'single_elimination',
    prizeReward: '$9,000',
    entryFee: 800,
    organizerId: 'user-bob-789',
