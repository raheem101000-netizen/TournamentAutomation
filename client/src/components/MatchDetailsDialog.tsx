...
export default function MatchDetailsDialog({
  ...
  useEffect(() => {
    ...
    websocket.onopen = () => {
      console.log("WebSocket connected to match:", match.id);
    };
                ...
                <div className="space-y-2">
                  ...
                  >
                    <RadioGroupItem
                      value={team1.id}
                      id={team1.id}
                      data-testid="radio-winner-team1"
                    />
                  ...
                  >
                    <RadioGroupItem
                      value={team2.id}
                      id={team2.id}
                      data-testid="radio-winner-team2"
                    />
                    <Avatar className="h-10 w-10">
                      <AvatarFallback className="bg-primary/10 text-primary">
                        {getTeamInitials(team2.name)}
                          ...
                          <div className="rounded-md bg-muted p-3">
                            {msg.imageUrl && (
                              <img
                                src={msg.imageUrl}
                                alt="Shared image"
                                className="max-w-full h-auto max-h-60 object-contain mb-2"
                              />
                            )}
                            {msg.message && (
